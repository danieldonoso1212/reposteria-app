...
export function FormularioPublico() {
  ...
  const fechaMinima = new Date(Date.now() + 2 * 86400000).toISOString().split('T')[0]
          ...
          {recetas.length === 0 ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                {/* ✅ Tag corregido — mínimo 2 días desde hoy */}
                <input
                  type="date"
                  required
                  min={fechaMinima}
                ...
                <p className="text-xs text-cream-500 mt-1">
                  El pedido requiere mínimo 2 días de anticipación.
                </p>
              </div>
